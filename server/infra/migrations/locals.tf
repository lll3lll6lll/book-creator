locals {
  ...
  server_name_hash = fileexists(local.absolut_server_name_zip) ? filebase64sha256(local.absolut_server_name_zip) : null
  ...
  nm_name_hash = fileexists(local.absolut_nm_name_zip) ? filebase64sha256(local.absolut_nm_name_zip) : null
}
